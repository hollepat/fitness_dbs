...
@Entity
@Table(name = "trainerslicense", schema = "public", catalog = "hollepat")
@IdClass(TrainerslicenseEntityPK.class)
public class TrainerslicenseEntity {
    @Id
    @ManyToOne
    ...
    public boolean equals(Object o) {
        ...
        TrainerslicenseEntity that = (TrainerslicenseEntity) o;
